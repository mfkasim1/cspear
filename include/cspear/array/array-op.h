...
namespace csp {
  ...
  array<T,I,ContiguousView> array<T,I,View>::operator-() const {
    return unary_op<array<T,I,ContiguousView>,ufunc::neg<T> >(*this);
  }

  template <typename T, typename I, template<typename> typename View>
  array<T,I,ContiguousView> array<T,I,View>::operator+(T a) const {
  ...
  template <typename T, typename I, template<typename> typename View>
  array<T,I,ContiguousView> array<T,I,View>::reciprocal(T a) const {
    return ewise_binary_op_with_val< array<T,I,ContiguousView>, ufunc::reciprocal<T> >(
      *this, a);
  }

  template <typename T, typename I, template<typename> typename View>
  array<T,I,ContiguousView> array<T,I,View>::clip_lb(T lb) const {
    return ewise_binary_op_with_val< array<T,I,ContiguousView>, ufunc::clip_lb<T> >(
      *this, lb);
  }

  template <typename T, typename I, template<typename> typename View>
  array<T,I,ContiguousView> array<T,I,View>::clip_ub(T ub) const {
  ...
  template <typename T, typename I, template<typename> typename View>
  array<bool,I,ContiguousView> array<T,I,View>::operator!() const {
    return unary_op< array<bool,I,ContiguousView>,ufunc::logical_not<T> >(*this);
  }

  template <typename T, typename I, template<typename> typename View>
  array<bool,I,ContiguousView> array<T,I,View>::operator>(T a) const {
  ...
  array<T,I,ContiguousView> array<T,I,View>::operator+(const array<T,I,View2>& a) const {
  ...
  template <typename T, typename I, template<typename> typename View>
  template <template<typename> typename View2>
  array<bool,I,ContiguousView> array<T,I,View>::operator>(const array<T,I,View2>& a) const {
